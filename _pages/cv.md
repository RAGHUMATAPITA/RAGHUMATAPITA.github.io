...
* **Postdoctoral researcher:** June 2023 - present
  ...
  * Duties includes:
    ...
    * Analysis on charged-particle suppression in oxygen-oxygen collisions with the CMS experiment
    * Analysis on charged-particle suppression in neon-neon collisions with the CMS experiment
...
* **Ph.D. student:** July 2018 - June 2023
  ...
  * Duties includes:
    * Analysis on strange hadron femtoscopy with the CMS experiment
    * Analysis on strange hadron collectivity with the CMS experiment
    * L3 convener under PdmV group (Monte Carlo request manager)
    * Release data and Monte Carlo validator for SiStrip and PixelPhase-1
